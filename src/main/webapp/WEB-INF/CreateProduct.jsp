...
<html>
<head>
    <title>Nuevo Producto-HandCraftVerse</title>
...
<div class="relative">
        <%--@elvariable id="producto" type=""--%>
        <form:form action="/createNewProduct" method="post" modelAttribute="producto">
            <table>
                <tr>
                    <td>Nombre:</td>
                ...
                <tr>
                    <td>Precio:</td>
                    <td>     <form:input class="w-full border border-gray-300 rounded-md hover:border-moradoResaltar focus:border-moradoResaltar focus:ring focus:ring-moradoPrincipal" path="precio" />
                    </td>
                </tr>
                <tr>
                    <td>Stock:</td>
                    <td><form:input class="w-full border border-gray-300 rounded-md hover:border-moradoResaltar focus:border-moradoResaltar focus:ring focus:ring-moradoPrincipal" path="stock" /></td>
                </tr>
                <tr>
                    <td>Descripción:</td>
                    <td><form:textarea class="w-full border border-gray-300 rounded-md hover:border-moradoResaltar focus:border-moradoResaltar focus:ring focus:ring-moradoPrincipal" path="descripcion" /></td>
                </tr>
                <tr>
                    <td>Personalizable:</td>
                    <td><form:checkbox class="h-4 w-4 text-moradoResaltar border border-gray-300 rounded-md focus:ring-moradoPrincipal" path="personalizable" /></td>
                </tr>
                <tr>
                    <td>Categoría ID:</td>
                    <td><form:input class="w-full border border-gray-300 rounded-md hover:border-moradoResaltar focus:border-moradoResaltar focus:ring focus:ring-moradoPrincipal" path="categoriaID" /></td>
                </tr>
            </table>
